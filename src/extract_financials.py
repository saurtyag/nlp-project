...
class FinDataExtractor:
    def __init__(self,quandl_key,av_key):
        ...
        self.gspc_df = pd.read_csv("../data/index/gspc.csv",parse_dates=['Date'],index_col="Date")
        # Get VIX index data downloaded from Yahoo Finance
        self.vix_df = pd.read_csv("../data/index/vix.csv",parse_dates=['Date'],index_col="Date")
